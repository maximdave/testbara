    ...
    return (
        <section className="section-container">
            <header className="flex justify-between">
                ...
                <h2 className="mr-3 md:mr-5 lg:mr-10 text-sm lg:text-base border">Recommended For you</h2>
                    <p className="section-text-italic text-sm lg:text-xl">We’ve got you in mind</p>
